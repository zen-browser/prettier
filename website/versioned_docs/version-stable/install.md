...
```bash
npm install --save-dev --save-exact prettier@3.8.2
```
...
```bash
yarn add --dev --exact prettier@3.8.2
```
...
```bash
pnpm add --save-dev --save-exact prettier@3.8.2
```
...
```bash
bun add --dev --exact prettier@3.8.2
```
